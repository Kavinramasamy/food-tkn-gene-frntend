...
const SignUpPage = () => {
    ...
    const { handleBlur, handleChange, handleSubmit, values, errors, touched } =
        useFormik({
            ...
            onSubmit: async (signUpInfo) => {
                ...
                localStorage.setItem("food-token-gene-email", signUpInfo.email);
                try {
    ...
    return (
        <div className="second-entry bg-dark" style={{ height: "100vh" }}>
            <h1 className="text-warning text-center">SignUp Page</h1>
            <form className="text-start p-5" onSubmit={handleSubmit}>
                ...
                <div className="form-group text-light">
                    <label for="exampleInputPassword1 text-light">Password</label>
                    <input
                        type="password"
